    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <ul class="navbar-nav">
              ...
              echo"<li class='nav-item'> <a href='accountp.php' class='nav-link'>Account</a> </li>
              ...
              echo"<h1 style='color:black;position:sticky;'>WELCOME </h1><b style = 'color: black;font-size: 25px'><i> ".ucwords($rel['name'])." !</i></b>
                ...
                <div class='row'>
                  <div class='col'>
                    <form action='moviep.php' method='POST'>
