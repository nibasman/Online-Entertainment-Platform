  ...
  echo"<html lang='en' dir='ltr'>";
    ...
    echo"<body>";
        ...
        while($result = mysqli_fetch_assoc($records)){
          ...
          echo "<br><br><h5 style='display: inline;'><br>Series name : </h5><h1 style='display: inline;'>".ucwords($result['name'])."</h1>";
          echo"<br><h5 style='display: inline;' >genre : </h5><h4 style='display: inline;'>".ucwords($result['genre'])."</h4>";
          echo"<br><h5 style='display: inline;' >Season : </h5><h4 style='display: inline;'>".ucwords($result['ssn'])."</h4>";
          echo"<h5 style='display: inline;' >Episode No : </h5><h4 style='display: inline;'>".ucwords($result['epino'])."</h4>";
          ...
          echo"<br><h5 style='display: inline;' >rating : </h5><h4 style='display: inline;'>".$result['rating']."</h4><h4 style='display: inline;' >/10</h4>";
