  ...
  echo"<html lang='en' dir='ltr'>";
    ...
    echo"<body>";
        ...
        while($result = mysqli_fetch_assoc($records)){
            ...
            echo"<br>";
            echo"<a href='homepagep.php' style='font-size: 20px;color:orange;border:1px solid orange;border-radius:5px;padding:10px;text-decoration:none;'>Back to Home </a>";
          ...
          echo"<iframe class='embed-responsive-item' src='https://www.youtube.com/watch?v=lXed5Inp844' frameborder='0' allowfullscreen ></iframe>";
          echo"</video>";
          echo"</div>";
